...
struct qt_meta_stringdata_ParamWindow_t {
    QByteArrayData data[4];
    char stringdata0[31];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ParamWindow_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ParamWindow_t qt_meta_stringdata_ParamWindow = {
    {
QT_MOC_LITERAL(0, 0, 11), // "ParamWindow"
QT_MOC_LITERAL(1, 12, 6), // "okSlot"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 10) // "cancelSlot"

    },
    "ParamWindow\0okSlot\0\0cancelSlot"
};
...
void ParamWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ParamWindow *_t = static_cast<ParamWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ParamWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ParamWindow.data,
      qt_meta_data_ParamWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ParamWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ParamWindow.stringdata0))
